...
如果有此種類的多個編輯，編輯器會顯示選擇器。如果沒有此種類的編輯，編輯器會顯示錯誤訊息。`,"貼上為...","貼上為文字","是否顯示貼上小工具","顯示貼上選項...","找不到 '{0}' 的貼上編輯","正在解析貼上編輯。按一下以取消","執行貼上處理常式。按一下以取消並執行基本貼上","選取貼上動作","執行貼上處理常式","插入純文字","插入 URI","插入 URI","插入路徑","插入路徑","插入相對路徑","插入相對路徑","插入 HTML",null,"是否顯示卸除小工具","顯示卸除選項...","正在執行置放處理常式。按一下以取消",`解析編輯 '{0}' 時發生錯誤:\r
{1}`,`套用編輯 '{0}' 時發生錯誤:\r
